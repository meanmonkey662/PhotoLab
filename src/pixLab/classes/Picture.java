...
public class Picture extends SimplePicture {
	...
	// makes the pixels have zero red
	public void zeroRed() {
		Pixel[][] pixels = this.getPixels2D();
		for (Pixel[] rowArray : pixels) {
			for (Pixel pixelObj : rowArray) {
	...
	// makes the pixels have zero green.
	...
	// makes the pixels have a certain amount of blue everywhere.
	public void Blue() {
		Pixel[][] pixels = this.getPixels2D();
		for (Pixel[] rowArray : pixels) {
			for (Pixel pixelObj : rowArray) {
				pixelObj.setBlue(101);
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		galaxy.explore();
		galaxy.zeroRed();
		galaxy.createCollage();
		galaxy.mirrorVertical();
		galaxy.explore();
		galaxy.Blue();
		galaxy.explore();
		galaxy.write("WeirdGalaxy.jpg");
